...
=== Share
.request
include::{snippets}/patient/share/http-request.adoc[]

.response
include::{snippets}/patient/share/http-response.adoc[]
...
=== Share
.request
include::{snippets}/physician/share/http-request.adoc[]

.response
include::{snippets}/physician/share/http-response.adoc[]
...
=== Share
.request
include::{snippets}/labtest/share/http-request.adoc[]

.response
include::{snippets}/labtest/share/http-response.adoc[]
