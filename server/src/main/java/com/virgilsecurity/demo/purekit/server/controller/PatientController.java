...
public class PatientController {
	...
	@GetMapping("/share/{physicianId}")
	public void share(@RequestHeader(Constants.GRANT_HEADER) PureGrant grant,
			@PathVariable("physicianId") String physicianId) {
		this.patientService.shareSsn(physicianId, grant);
	}
